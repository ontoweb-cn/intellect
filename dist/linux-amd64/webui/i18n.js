...
const LOCALES = {
  en: {
    ...
    offline_network_detail: 'Intellect is unreachable from this browser right now.',
    offline_autorefresh: 'I will refresh this page automatically when Intellect is reachable again.',
    ...
    mcp_restart_hint: 'Server changes are read-only here for now. Edit config.yaml and restart Intellect for changes to take effect.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" may not work with your configured provider (${p}). Send anyway, or run \`intellect model\` in your terminal to switch.`,
    ...
    cmd_theme: 'Switch appearance (theme: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: 'Switch agent personality',
    cmd_skills: 'List available Intellect skills',
  ...
  status_agent_running:'Agent running',
    ...
    status_intellect_home: 'Intellect home',
  ...
  untitled:'Untitled',
    no_personalities: 'No personalities found (add them to ~/.intellect/personalities/)',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for Intellect Web UI.',
    ...
    settings_plugins_meta: 'View installed Intellect plugins and the lifecycle hooks they register. This panel is read-only.',
    settings_plugins_empty: 'No Intellect plugins are currently visible. Install or enable plugins from the Intellect CLI/config to see them here.',
    ...
    settings_label_dashboard_title: 'Dashboard title',
    ...
    tab_members: 'Members',
    tab_teams: 'Teams',
    members_panel_desc: 'People, OAuth identities, API tokens, and teams for this profile.',
    members_disabled: 'Members are not enabled for this profile.',
    members_sign_in_first: 'Sign in to manage members.',
    members_identities: 'Linked accounts',
    members_password: 'Account password',
    member_password_required_title: 'Set your password',
    member_password_required_sub: 'Choose a password before continuing. You can use member id + password to sign in later.',
    member_password_change_title: 'Change password',
    member_password_change_sub: 'Update your member sign-in password.',
    member_password_set_sub: 'Set a password to sign in with member id + password.',
    member_password_current: 'Current password',
    member_password_new: 'New password',
    member_password_confirm: 'Confirm password',
    member_password_save: 'Save password',
    member_password_saved: 'Password saved',
    member_password_save_failed: 'Could not save password',
    member_password_sign_out: 'Sign out',
    members_api_tokens: 'API tokens',
    members_token_label: 'Label',
    members_create_token: 'Create token',
    members_token_created: 'Token created — copied to clipboard',
    members_no_tokens: 'No API tokens.',
    members_no_identities: 'No linked OAuth identities.',
    members_invites: 'Invites',
    members_pending_registrations: 'Pending registrations',
    members_pending_registrations_empty: 'No pending registrations.',
    members_approve_registration: 'Approve',
    members_reject_registration: 'Reject',
    members_registration_approved: 'Registration approved',
    members_registration_rejected: 'Registration rejected',
    members_invite_member_id: 'Reserved member id (optional)',
    members_create_invite: 'Create invite',
    members_team_id: 'Team id',
    members_join_team: 'Request join',
    members_join_requested: 'Join request sent',
    member_login_title: 'Sign in',
    member_login_sub: 'Use your organization account to access this Intellect profile.',
    member_login_invite: 'Invite code (optional)',
    member_login_no_providers: 'No OAuth providers configured.',
    member_not_signed_in: 'Not signed in',
    member_team_none: 'No team',
    member_team_banner: 'Select an active team to continue.',
    member_sign_out: 'Sign out',
    titlebar_current_team: 'Current team',
    profile_section_personal: 'Personal info',
    profile_section_teams: 'Teams',
    profile_username: 'Username',
    profile_avatar: 'Avatar',
    profile_upload_avatar: 'Upload',
    profile_remove_avatar: 'Remove',
    profile_save_username: 'Save username',
    profile_save_password: 'Save password',
    profile_local_user: 'Local user',
    profile_team_none: 'No team selected',
    profile_username_required: 'Username is required',
    profile_username_saved: 'Username saved',
    profile_password_required: 'Enter a password',
    profile_avatar_removed: 'Avatar removed',
    profile_avatar_saved: 'Avatar updated',
    profile_avatar_type_error: 'Use JPEG, PNG, or WebP',
    profile_avatar_size_error: 'Avatar must be 512KB or smaller',
    profile_save_failed: 'Save failed: ',
    unlink: 'Unlink',
    revoke: 'Revoke',
    teams_panel_desc: 'Join teams, pick an active team, and approve requests.',
    teams_disabled_members: 'Enable members.enabled in config.yaml first.',
    teams_disabled_teams: 'Enable members.teams.enabled in config.yaml.',
    teams_sign_in_first: 'Sign in to manage teams.',
    teams_multi_banner: 'Select an active team from the account menu.',
    teams_my_teams: 'My teams',
    teams_no_memberships: 'No team memberships yet.',
    teams_active: 'Active',
    teams_use: 'Use',
    teams_join: 'Join a team',
    teams_create: 'Create team',
    teams_display_name: 'Display name',
    teams_admin: 'Admin',
    teams_no_pending: 'No pending join requests.',
    teams_approve: 'Approve',
    teams_reject: 'Reject',
    teams_active_set: 'Active team updated',
    teams_context_refreshed: 'Active team updated — chat refreshed.',
    teams_created: 'Team created',
    teams_approved: 'Member approved',
    teams_rejected: 'Request rejected',
    teams_open_panel: 'Open Teams panel',
    members_setup_title: 'Members & OAuth',
    members_setup_desc: 'Multi-user mode uses the intellect-agent membership database. Member OAuth callbacks must reach this WebUI origin (not the agent dashboard on :9009).',
    members_setup_off: 'Members disabled (members.enabled: false).',
    members_setup_unavailable: 'Members API unavailable (intellect-agent required).',
    members_setup_mode: 'Mode',
    members_setup_oauth_on: 'Member OAuth enabled',
    members_setup_oauth_off: 'Member OAuth disabled',
    members_setup_actor: 'Signed in as',
    members_setup_teams_on: 'Teams enabled',
    members_setup_local_requires_approval: 'Allow local account self-registration (requires admin approval before sign-in)',
    members_setup_callback_title: 'Suggested OAuth callback base',
    members_setup_callback_hint: 'Add to config.yaml: members.oauth.callback_base_url set to your WebUI public URL (scheme + host + port). IdP redirect URI becomes {base}/api/members/oauth/callback.',
    members_redeem_invite: 'Redeem invite',
    members_redeem_hint: 'Enter an invite code from a profile admin to join this Intellect profile.',
    members_redeem_code_placeholder: 'FAM-…',
    members_redeem_member_id: 'Member id (optional)',
    members_redeem_btn: 'Redeem',
    members_redeem_code_required: 'Enter an invite code',
    members_redeemed_toast: 'Signed in as {id}',
    members_sign_in_or_redeem: 'Sign in with OAuth or redeem an invite code.',
    members_sign_in_or_register: 'Sign in or create an account to continue.',
    members_open_register: 'Create account',
    members_open_login: 'Sign in',
    members_oauth_sign_in: 'Sign in with OAuth',
    members_link_provider: 'Link',
    members_link_provider_hint: 'Link another sign-in method to this member:',
    members_all_providers_linked: 'All configured providers are already linked.',
    oauth_choose_provider: 'Choose a sign-in provider',
    oauth_sign_in_with: 'Sign in with {name}',
    oauth_register_with: 'Register with {name}',
    oauth_link_with: 'Link {name}',
    register_oauth_pick_provider: 'Complete the form, then choose a provider icon.',
    register_oauth_hint: 'Fill in member id, display name, and password, then pick a provider icon.',
    members_link_failed: 'Could not start OAuth link',
    members_unlinked: 'Identity unlinked',
    members_invite_copied: 'Invite code created (copied)',
    tab_kanban: 'Kanban',
    kanban_board: 'Board',
    ...
    kanban_work_queue_hint: 'This is the Intellect Agent work queue. Create or triage a task, assign it, move it to Ready, then let the dispatcher claim it.',
    ...
    kanban_assignee_profiles_label: 'Intellect profiles',
    ...
    tab_dashboard: 'Intellect Dashboard',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — Intellect auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',
    ...
    settings_desc_sync_insights: 'Mirrors WebUI token usage to state.db so intellect /insights includes browser session data. Off by default.',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to Intellect.',
    settings_desc_dashboard_title: 'Shown next to the logo in the top bar. Defaults to Intellect Agent Harness.',
    settings_desc_password: 'Enter a new password to set or change it. Leave blank to keep current setting.',
    password_placeholder: 'Enter new password…',
    password_env_var_locked: 'The INTELLECT_WEBUI_PASSWORD environment variable is currently set and takes precedence. Unset it and restart the server to manage the password from here.',
    password_env_var_locked_placeholder: 'Locked: INTELLECT_WEBUI_PASSWORD env var is set',
    ...
    providers_oauth_config_yaml_hint: 'Token configured via config.yaml. To update, edit the providers section in your config.yaml or run intellect auth.',
    providers_oauth_not_configured_hint: 'Not authenticated. Run intellect auth in the terminal to configure this provider.',
    oauth_status_connected: 'Connected',
    oauth_status_disconnected: 'Not connected',
    oauth_login: 'Login',
    oauth_login_title: 'OAuth Login',
    oauth_disconnect: 'Disconnect',
    oauth_disconnect_confirm: 'Disconnect this OAuth provider?',
    oauth_disconnected: 'OAuth provider disconnected.',
    oauth_disconnect_failed: 'Failed to disconnect provider.',
    oauth_docs: 'Docs',
    oauth_external_hint: 'Run this command in your terminal:',
    oauth_pkce_step1: '1. Open the authorization page in a new tab',
    oauth_pkce_step2: '2. After authorizing, paste the code from the callback URL below',
    oauth_open_auth_page: 'Open Authorization Page',
    oauth_paste_code: 'Paste code here...',
    oauth_submit: 'Submit',
    oauth_device_step1: '1. Visit this URL',
    oauth_device_step2: '2. Enter this code on the page',
    oauth_device_polling: 'Waiting for authorization...',
    oauth_login_success: 'OAuth login successful!',
    providers_oauth_title: 'OAuth Providers',
    providers_save: 'Save',
    ...
    onboarding_title: 'Welcome to Intellect Web UI',
    onboarding_lead: 'A quick guided setup will verify Intellect, save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open Intellect',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify Intellect Agent and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum Intellect provider config.',
    ...
    onboarding_notice_system_ready: 'Intellect Agent looks reachable from the Web UI.',
    onboarding_notice_system_unavailable: 'Intellect Agent is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: 'Choose a simple provider path here. Advanced OAuth flows still belong in the Intellect CLI for now.',
    onboarding_notice_setup_already_ready: 'A working Intellect provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: 'This instance is configured to use an OAuth provider (<strong>{provider}</strong>) that was set up via the Intellect CLI. No API key is needed here — click Continue to finish setup.',
    onboarding_oauth_provider_not_ready_title: 'OAuth provider not yet authenticated',
    onboarding_oauth_provider_not_ready_body: 'This instance is configured to use <strong>{provider}</strong>, which uses OAuth rather than an API key. Run <code>intellect auth</code> or <code>intellect model</code> in a terminal to authenticate, then reload the Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Saved as a secret in your Intellect .env file using',
    ...
    onboarding_workspace_help: 'Pick the model Intellect should use for new chats after setup completes.',
  ...
  it: {
    ...
    offline_network_detail: 'Intellect non è raggiungibile da questo browser al momento.',
    offline_autorefresh: 'Aggiornerò automaticamente la pagina quando Intellect sarà di nuovo raggiungibile.',
    ...
    mcp_restart_hint: 'Le modifiche ai server sono in sola lettura qui. Modifica config.yaml e riavvia Intellect per applicare le modifiche.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" potrebbe non funzionare con il provider configurato (${p}). Invia comunque, o esegui \`intellect model\` nel terminale per cambiare.`,
    ...
    cmd_theme: 'Cambia aspetto (tema: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: "Cambia personalità dell'agente",
    cmd_skills: 'Elenca le skill Intellect disponibili',
  ...
  status_agent_running:'Agente in esecuzione',
    ...
    status_intellect_home: 'Home Intellect',
  ...
  untitled:'Senza titolo',
    no_personalities: 'Nessuna personalità trovata (aggiungile in ~/.intellect/personalities/)',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    settings_section_preferences_meta: 'Predefiniti e comportamento UI per Intellect Web UI.',
    ...
    settings_plugins_meta: 'View installed Intellect plugins and the lifecycle hooks they register. This panel is read-only.',  // TODO: translate
    settings_plugins_empty: 'No Intellect plugins are currently visible. Install or enable plugins from the Intellect CLI/config to see them here.',  // TODO: translate
    ...
    kanban_work_queue_hint: 'Questa è la coda di lavoro di Intellect Agent. Crea o classifica un task, assegnalo, spostalo in Pronto, poi lascia che il dispatcher lo reclami.',
    ...
    kanban_assignee_profiles_label: 'Profili Intellect',
    ...
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_dashboard: 'Dashboard Intellect',
    ...
    settings_desc_sync_insights: 'Rispecchia l\'uso token WebUI su state.db così intellect /insights include i dati delle sessioni browser. Disattivato per impostazione predefinita.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Nome visualizzato per l\'assistente in tutta l\'interfaccia. Predefinito: Intellect.',
    ...
    password_env_var_locked: 'La variabile d\'ambiente INTELLECT_WEBUI_PASSWORD è attualmente impostata e ha la precedenza. Rimuovila e riavvia il server per gestire la password da qui.',
    password_env_var_locked_placeholder: 'Bloccato: variabile d\'ambiente INTELLECT_WEBUI_PASSWORD impostata',
    ...
    providers_oauth_config_yaml_hint: 'Token configurato via config.yaml. Per aggiornare, modifica la sezione providers in config.yaml o esegui intellect auth.',
    providers_oauth_not_configured_hint: 'Non autenticato. Esegui intellect auth nel terminale per configurare questo provider.',
    ...
    onboarding_title: 'Benvenuto in Intellect Web UI',
    onboarding_lead: 'Una configurazione guidata rapida verificherà Intellect, salverà una configurazione provider reale, sceglierà un workspace e un modello e opzionalmente proteggerà l\'app con una password.',
    ...
    onboarding_open: 'Apri Intellect',
    onboarding_step_system_title: 'Verifica sistema',
    onboarding_step_system_desc: 'Verifica Intellect Agent e visibilità configurazione.',
    onboarding_step_setup_title: 'Configurazione provider',
    onboarding_step_setup_desc: 'Salva la configurazione minima provider Intellect.',
    ...
    onboarding_notice_system_ready: 'Intellect Agent sembra raggiungibile dalla Web UI.',
    onboarding_notice_system_unavailable: 'Intellect Agent non è ancora completamente disponibile. Bootstrap può installarlo, ma la configurazione provider potrebbe richiedere un terminale.',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: 'Scegli un percorso provider semplice qui. I flussi OAuth avanzati rimangono nella CLI di Intellect per ora.',
    onboarding_notice_setup_already_ready: 'Una configurazione provider Intellect funzionante è già stata rilevata. Puoi mantenerla o sostituirla qui.',
    onboarding_oauth_provider_ready_title: 'Provider già autenticato',
    onboarding_oauth_provider_ready_body: 'Questa istanza è configurata per usare un provider OAuth (<strong>{provider}</strong>) impostato tramite la CLI di Intellect. Nessuna chiave API necessaria — clicca Continua per finire.',
    onboarding_oauth_provider_not_ready_title: 'Provider OAuth non ancora autenticato',
    onboarding_oauth_provider_not_ready_body: 'Questa istanza è configurata per usare <strong>{provider}</strong>, che usa OAuth invece di una chiave API. Esegui <code>intellect auth</code> o <code>intellect model</code> in un terminale per autenticarti, poi ricarica la Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Salvato come segreto nel tuo file .env di Intellect usando',
    ...
    onboarding_workspace_help: 'Scegli il modello che Intellect userà per le nuove chat dopo la configurazione.',
  ...
  ja: {
    ...
    offline_network_detail: '現在、このブラウザからIntellectに到達できません。',
    offline_autorefresh: 'Intellectに再接続できたら、このページを自動的に更新します。',
    ...
    mcp_restart_hint: 'ここでのサーバー変更は現状読み取り専用です。反映するには config.yaml を編集して Intellect を再起動してください。',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" は設定されたプロバイダ (${p}) で動作しない可能性があります。このまま送信するか、ターミナルで \`intellect model\` を実行して切り替えてください。`,
    ...
    cmd_theme: '外観を切り替え (theme: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: 'エージェントのパーソナリティを切り替え',
    cmd_skills: '利用可能な Intellect スキルを一覧表示',
  ...
  status_agent_running:'エージェント実行中',
    ...
    status_intellect_home: 'Intellect ホーム',
    status_started: '開始',
    status_tokens: 'トークン',
    status_updated: '更新',
  ...
  untitled:'無題',
    no_personalities: 'パーソナリティが見つかりません (~/.intellect/personalities/ に追加してください)',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'Intellect Web UI のデフォルトと UI 動作。',
    ...
    kanban_work_queue_hint: 'これは Intellect Agent のワークキューです。タスクを作成またはトリアージし、担当者を割り当て、Ready に移動すると、ディスパッチャーがそれをクレームします。',
    ...
    kanban_assignee_profiles_label: 'Intellect プロファイル',
    ...
    tab_todos: 'ToDo',
    tab_insights: 'インサイト',
    tab_dashboard: 'Intellect ダッシュボード',
    ...
    settings_desc_sync_insights: 'WebUI のトークン使用量を state.db にミラーし、intellect /insights にブラウザセッションのデータを含めます。デフォルトはオフ。',
    settings_desc_check_updates: 'WebUI または Agent の新しいバージョンが利用可能な時にバナーを表示します。バックグラウンドで定期的に git fetch を実行します。',
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'UI 全体で表示されるアシスタントの名前。デフォルトは Intellect。',
    settings_desc_password: '新しいパスワードを入力すると設定または変更します。空欄なら現在の設定を維持。',
    password_placeholder: '新しいパスワードを入力…',
    password_env_var_locked: '現在 INTELLECT_WEBUI_PASSWORD 環境変数が設定されており優先されます。ここで管理するには変数を解除してサーバーを再起動してください。',
    password_env_var_locked_placeholder: 'ロック中: INTELLECT_WEBUI_PASSWORD 環境変数が設定されています',
    disable_auth: '認証を無効化',
    sign_out: 'サインアウト',
    // Providers panel
    ...
    providers_oauth_config_yaml_hint: 'config.yaml でトークンが設定されています。更新するには config.yaml の providers セクションを編集するか intellect auth を実行してください。',
    providers_oauth_not_configured_hint: '未認証です。ターミナルで intellect auth を実行してこのプロバイダを設定してください。',
    providers_save: '保存',
    providers_remove: '削除',
    ...
    onboarding_title: 'Intellect Web UI へようこそ',
    onboarding_lead: 'クイックガイドで Intellect を確認し、プロバイダ設定を保存し、ワークスペースとモデルを選択し、必要ならパスワードでアプリを保護します。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: 'Intellect を開く',
    onboarding_step_system_title: 'システム確認',
    onboarding_step_system_desc: 'Intellect Agent と設定の可視性を確認します。',
    onboarding_step_setup_title: 'プロバイダ設定',
    onboarding_step_setup_desc: '最低限の Intellect プロバイダ設定を保存します。',
    ...
    onboarding_notice_system_ready: 'Web UI から Intellect Agent へ到達できそうです。',
    onboarding_notice_system_unavailable: 'Intellect Agent はまだ完全には利用できません。Bootstrap でインストールできますが、プロバイダ設定にはターミナルが必要な場合があります。',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: 'シンプルなプロバイダ経路をここで選んでください。高度な OAuth フローは現状 Intellect CLI 側で扱います。',
    onboarding_notice_setup_already_ready: '動作する Intellect プロバイダ設定が既に検出されています。維持するか、ここで置き換えできます。',
    onboarding_oauth_provider_ready_title: 'プロバイダは認証済み',
    onboarding_oauth_provider_ready_body: 'このインスタンスは Intellect CLI で設定された OAuth プロバイダ (<strong>{provider}</strong>) を使用します。APIキーは不要 — 続けるをクリックしてセットアップを完了してください。',
    onboarding_oauth_provider_not_ready_title: 'OAuth プロバイダは未認証',
    onboarding_oauth_provider_not_ready_body: 'このインスタンスは <strong>{provider}</strong> を使用しますが、これは APIキー ではなく OAuth を使用します。ターミナルで <code>intellect auth</code> または <code>intellect model</code> を実行して認証し、Web UI を再読み込みしてください。',
    ...
    onboarding_api_key_help_prefix: 'Intellect の .env ファイルにシークレットとして保存されます — 使用変数:',
    ...
    onboarding_workspace_help: 'セットアップ完了後の新規チャットで Intellect が使用するモデルを選択してください。',
    onboarding_custom_model_placeholder: 'your-model-name',
  ...
  ru: {
    ...
    offline_network_detail: 'Intellect сейчас недоступен из этого браузера.',
    offline_autorefresh: 'Я автоматически обновлю страницу, когда Intellect снова станет доступен.',
    ...
    `"${m}" может не работать с вашим настроенным провайдером (${p}). Всё равно отправить или запустите \`intellect model\` в терминале, чтобы переключиться.`,
    ...
    cmd_theme: 'Переключить внешний вид (тема: system/dark/light, скин: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: 'Переключить личность агента',
    cmd_skills: 'Показать доступные навыки Intellect',
    ...
    no_personalities: 'Личности не найдены (добавьте их в ~/.intellect/personalities/)',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    kanban_assignee_profiles_label: 'Профили Intellect',
    ...
    tab_dashboard: 'Панель Intellect',
    ...
    settings_desc_sync_insights: 'Синхронизирует использование токенов WebUI в state.db, чтобы Intellect /insights включал данные браузерных сеансов. Выключено по умолчанию.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Отображаемое имя помощника во всём интерфейсе. По умолчанию Intellect.',
    ...
    password_env_var_locked: 'Переменная окружения INTELLECT_WEBUI_PASSWORD сейчас задана и имеет приоритет. Сбросьте её и перезапустите сервер, чтобы управлять паролем отсюда.',
    password_env_var_locked_placeholder: 'Заблокировано: задана переменная INTELLECT_WEBUI_PASSWORD',
    ...
    onboarding_title: 'Добро пожаловать в Intellect Web UI',
    onboarding_lead: 'Краткая пошаговая настройка проверит Intellect, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть Intellect',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить Intellect Agent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера Intellect.',
    ...
    onboarding_notice_system_ready: 'Intellect Agent, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: 'Intellect Agent ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: 'Выберите здесь простой путь настройки провайдера. Продвинутые OAuth-сценарии пока остаются в Intellect CLI.',
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера Intellect. Вы можете оставить её или заменить здесь.',
    onboarding_oauth_provider_ready_title: 'Провайдер уже авторизован',
    onboarding_oauth_provider_ready_body: 'Этот экземпляр настроен на использование OAuth-провайдера (<strong>{provider}</strong>), настроенного через Intellect CLI. API-ключ здесь не нужен — нажмите «Продолжить», чтобы завершить настройку.',
    onboarding_oauth_provider_not_ready_title: 'OAuth-провайдер ещё не авторизован',
    onboarding_oauth_provider_not_ready_body: 'Этот экземпляр настроен на использование <strong>{provider}</strong>, который работает через OAuth, а не через API-ключ. Запустите <code>intellect auth</code> или <code>intellect model</code> в терминале, чтобы пройти авторизацию, затем обновите Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Сохраняется как секрет в вашем файле `.env` Intellect с помощью',
    ...
    onboarding_workspace_help: 'Выберите модель, которую Intellect должен использовать для новых чатов после завершения настройки.',
    ...
    settings_desc_voice_mode: 'Показывать кнопку голосового режима (аудиоволны) рядом с микрофоном диктовки. Intellect автоматически отправляет реплики после паузы и зачитывает ответы вслух. Требуется браузер с поддержкой распознавания речи и TTS.',
  ...
  es: {
    ...
    offline_network_detail: 'Intellect no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando Intellect vuelva a estar disponible.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" puede no funcionar con tu proveedor configurado (${p}). Envía de todas formas, o ejecuta \`intellect model\` en la terminal para cambiar.`,
    ...
    cmd_theme: 'Cambiar apariencia (tema: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: 'Cambiar la personalidad del agente',
    cmd_skills: 'Listar las skills de Intellect disponibles',
    ...
    no_personalities: 'No se encontraron personalidades (añádelas a ~/.intellect/personalities/)',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    kanban_assignee_profiles_label: 'Perfiles Intellect',
    ...
    tab_dashboard: 'Panel de Intellect',
    ...
    settings_desc_sync_insights: 'Refleja el uso de tokens de la WebUI en state.db para que intellect /insights incluya datos de sesiones del navegador. Desactivado por defecto.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Nombre visible del asistente en toda la UI. Por defecto es Intellect.',
    ...
    password_env_var_locked: 'La variable de entorno INTELLECT_WEBUI_PASSWORD está definida y tiene prioridad. Quítala y reinicia el servidor para gestionar la contraseña desde aquí.',
    password_env_var_locked_placeholder: 'Bloqueado: la variable INTELLECT_WEBUI_PASSWORD está definida',
    ...
    onboarding_title: 'Bienvenido a Intellect Web UI',
    onboarding_lead: 'Una guía rápida verificará Intellect, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir Intellect',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica Intellect Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de Intellect.',
    ...
    onboarding_notice_system_ready: 'Parece que Intellect Agent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'Intellect Agent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de Intellect por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de Intellect. Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de Intellect. No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    onboarding_oauth_provider_not_ready_title: 'Proveedor OAuth no autenticado aún',
    onboarding_oauth_provider_not_ready_body: 'Esta instancia está configurada para usar <strong>{provider}</strong>, que utiliza OAuth en lugar de una clave API. Ejecuta <code>intellect auth</code> o <code>intellect model</code> en una terminal para autenticarte y recarga la interfaz web.',
    ...
    oauth_codex_error: 'OAuth login failed', // TODO: translate
    oauth_codex_expired: 'Code expired, please try again', // TODO: translate
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de Intellect usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Elige el modelo que Intellect debe usar para nuevos chats cuando termine la configuración.',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — Intellect auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',  // TODO: translate
  ...
  de: {
    ...
    offline_network_detail: 'Intellect ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald Intellect wieder erreichbar ist.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" funktioniert möglicherweise nicht mit Ihrem konfigurierten Provider (${p}). Trotzdem senden, oder \`intellect model\` im Terminal ausführen.`,
    ...
    cmd_theme: 'Darstellung wechseln (Theme: system/dark/light, Skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: 'Agenten-Persönlichkeit wechseln',
    cmd_skills: 'Verfügbare Intellect-Skills auflisten',
    ...
    no_personalities: 'Keine Persönlichkeiten gefunden (füge sie in ~/.intellect/personalities/ hinzu)',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    kanban_assignee_profiles_label: 'Intellect-Profile',
    ...
    settings_desc_sync_insights: 'Spiegelt den WebUI-Token-Verbrauch in die state.db, sodass intellect /insights Browser-Sitzungsdaten enthält. Standardmäßig aus.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Anzeigename für den Assistenten in der UI. Standardmäßig Intellect.',
    ...
    password_env_var_locked: 'Die Umgebungsvariable INTELLECT_WEBUI_PASSWORD ist gesetzt und hat Vorrang. Entferne sie und starte den Server neu, um das Passwort hier zu verwalten.',
    password_env_var_locked_placeholder: 'Gesperrt: INTELLECT_WEBUI_PASSWORD-Umgebungsvariable ist gesetzt',
    ...
    onboarding_title: 'Willkommen bei Intellect',
    ...
    onboarding_step_system_desc: 'Intellect Agent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie Intellect Agent.',
  ...
  zh: {
    ...
    offline_network_detail: '此浏览器当前无法连接到 Intellect。',
    offline_autorefresh: '当 Intellect 可访问时，我会自动刷新此页面。',
    ...
    mcp_restart_hint: '服务器更改目前为只读。请编辑 config.yaml 并重启 Intellect。',
    ...
    provider_mismatch_warning: (m,p)=>`\"${m}\" 可能无法在当前配置的提供商 (${p}) 下工作。直接发送，或在终端运行 \`intellect model\` 切换。`,
    ...
    cmd_theme: '切换外观（主题：system/dark/light，皮肤：default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin）',
    cmd_personality: '切换 Agent 人设',
    cmd_skills: '列出可用的 Intellect 技能',
    ...
    settings_plugins_meta: '查看已安装的 Intellect 插件及其注册的生命周期挂钩。此面板为只读。',
    settings_plugins_empty: '当前没有可见的 Intellect 插件。通过 Intellect CLI/配置文件安装或启用插件后即可在此查看。',
    ...
    no_personalities: '没有找到人设（可添加到 ~/.intellect/personalities/）',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_label_dashboard_title: 'Dashboard 标题',
    ...
    kanban_work_queue_hint: '这是 Intellect Agent 的工作队列。创建或分类任务，分配任务，将其移至“就绪”状态，然后让调度员认领任务。',
    ...
    kanban_assignee_profiles_label: 'Intellect 配置',
    ...
    tab_logs: '日志',
    tab_settings: '设置',
    members_panel_desc: '本配置下的成员、OAuth 身份、API 令牌与团队。',
    members_disabled: '此配置未启用成员功能。',
    members_sign_in_first: '请先登录以管理成员。',
    members_identities: '已绑定账号',
    members_password: '账号密码',
    member_password_required_title: '请设置密码',
    member_password_required_sub: '继续之前请先设置密码。之后可使用成员 ID + 密码登录。',
    member_password_change_title: '修改密码',
    member_password_change_sub: '更新您的成员登录密码。',
    member_password_set_sub: '设置密码后可使用成员 ID + 密码登录。',
    member_password_current: '当前密码',
    member_password_new: '新密码',
    member_password_confirm: '确认密码',
    member_password_save: '保存密码',
    member_password_saved: '密码已保存',
    member_password_save_failed: '无法保存密码',
    member_password_sign_out: '退出登录',
    members_api_tokens: 'API 令牌',
    members_token_label: '标签',
    members_create_token: '创建令牌',
    members_token_created: '令牌已创建（已复制到剪贴板）',
    members_no_tokens: '暂无 API 令牌。',
    members_no_identities: '暂无 OAuth 绑定。',
    members_invites: '邀请',
    members_pending_registrations: '待审核注册',
    members_pending_registrations_empty: '暂无待审核注册。',
    members_approve_registration: '通过',
    members_reject_registration: '拒绝',
    members_registration_approved: '已通过注册',
    members_registration_rejected: '已拒绝注册',
    members_invite_member_id: '预留成员 ID（可选）',
    members_create_invite: '创建邀请码',
    members_team_id: '团队 ID',
    members_join_team: '申请加入',
    members_join_requested: '已提交加入申请',
    member_login_title: '登录',
    member_login_sub: '使用组织账号访问此 Intellect 配置。',
    member_login_invite: '邀请码（可选）',
    member_login_no_providers: '未配置 OAuth 提供商。',
    member_not_signed_in: '未登录',
    member_team_none: '无团队',
    member_team_banner: '请选择一个活跃团队以继续。',
    member_sign_out: '退出登录',
    titlebar_current_team: '当前团队',
    profile_section_personal: '个人信息',
    profile_section_teams: '团队信息',
    profile_username: '用户名',
    profile_avatar: '个人肖像',
    profile_upload_avatar: '上传',
    profile_remove_avatar: '移除',
    profile_save_username: '保存用户名',
    profile_save_password: '保存密码',
    profile_local_user: '本地用户',
    profile_team_none: '未选择团队',
    profile_username_required: '请输入用户名',
    profile_username_saved: '用户名已保存',
    profile_password_required: '请输入密码',
    profile_avatar_removed: '肖像已移除',
    profile_avatar_saved: '肖像已更新',
    profile_avatar_type_error: '请使用 JPEG、PNG 或 WebP',
    profile_avatar_size_error: '肖像不能超过 512KB',
    profile_save_failed: '保存失败：',
    unlink: '解绑',
    revoke: '撤销',
    teams_panel_desc: '加入团队、选择活跃团队、审批加入请求。',
    teams_disabled_members: '请先在 config.yaml 中启用 members.enabled。',
    teams_disabled_teams: '请先在 config.yaml 中启用 members.teams.enabled。',
    teams_sign_in_first: '请先登录以管理团队。',
    teams_multi_banner: '请在账户菜单中选择活跃团队。',
    teams_my_teams: '我的团队',
    teams_no_memberships: '尚未加入任何团队。',
    teams_active: '当前',
    teams_use: '使用',
    teams_join: '加入团队',
    teams_create: '创建团队',
    teams_display_name: '显示名称',
    teams_admin: '管理',
    teams_no_pending: '暂无待审批的加入请求。',
    teams_approve: '批准',
    teams_reject: '拒绝',
    teams_active_set: '已更新活跃团队',
    teams_context_refreshed: '已切换活跃团队，聊天已刷新。',
    teams_created: '团队已创建',
    teams_approved: '已批准成员',
    teams_rejected: '已拒绝请求',
    teams_open_panel: '打开团队面板',
    members_setup_title: '成员与 OAuth',
    members_setup_desc: '多用户模式使用 intellect-agent 成员数据库。Member OAuth 回调必须指向本 WebUI 地址（不是 :9009 的 agent dashboard）。',
    members_setup_off: '成员功能未启用（members.enabled: false）。',
    members_setup_unavailable: '成员 API 不可用（需要 intellect-agent）。',
    members_setup_mode: '模式',
    members_setup_oauth_on: '已启用成员 OAuth',
    members_setup_oauth_off: '未启用成员 OAuth',
    members_setup_actor: '当前成员',
    members_setup_teams_on: '已启用团队',
    members_setup_local_requires_approval: '允许本地账号自助注册（需管理员审核通过后才能登录）',
    members_setup_callback_title: '建议的 OAuth 回调地址',
    members_setup_callback_hint: '在 config.yaml 中设置 members.oauth.callback_base_url 为 WebUI 对外 URL（含协议、主机、端口）。IdP 重定向 URI 为 {base}/api/members/oauth/callback。',
    members_redeem_invite: '兑换邀请码',
    members_redeem_hint: '输入 profile 管理员发放的邀请码以加入此 Intellect 配置。',
    members_redeem_code_placeholder: 'FAM-…',
    members_redeem_member_id: '成员 ID（可选）',
    members_redeem_btn: '兑换',
    members_redeem_code_required: '请输入邀请码',
    members_redeemed_toast: '已登录为 {id}',
    members_sign_in_or_redeem: '请使用 OAuth 登录或兑换邀请码。',
    members_sign_in_or_register: '请登录或创建账号以继续。',
    members_open_register: '创建账号',
    members_open_login: '登录',
    members_oauth_sign_in: 'OAuth 登录',
    members_link_provider: '绑定',
    members_link_provider_hint: '为此成员绑定其他登录方式：',
    members_all_providers_linked: '已绑定所有已配置的提供商。',
    oauth_choose_provider: '选择登录方式',
    oauth_sign_in_with: '使用 {name} 登录',
    oauth_register_with: '使用 {name} 注册',
    oauth_link_with: '绑定 {name}',
    register_oauth_pick_provider: '请填写表单后，再点击提供商图标。',
    register_oauth_hint: '填写成员 ID、显示名称和密码后，点击一个提供商图标。',
    members_link_failed: '无法启动 OAuth 绑定',
    members_unlinked: '已解绑身份',
    members_invite_copied: '邀请码已创建（已复制）',
    ...
    providers_oauth_config_yaml_hint: '通过 config.yaml 配置的令牌。如需更新，请编辑 config.yaml 中的 providers 部分或运行 intellect auth。',
    providers_oauth_not_configured_hint: '未认证。在终端中运行 intellect auth 以配置此提供商。',
    providers_save: '保存',
    providers_remove: '移除',
    providers_saving: '保存中…',
    ...
    password_env_var_locked: '当前已设置 INTELLECT_WEBUI_PASSWORD 环境变量并具有优先级。请取消该变量并重启服务器，才能在此管理密码。',
    password_env_var_locked_placeholder: '已锁定：已设置 INTELLECT_WEBUI_PASSWORD 环境变量',
    disable_auth: '取消认证',
    ...
    settings_desc_sync_insights: '将 WebUI token 使用情况同步到 state.db，使 intellect /insights 包含浏览器会话数据。默认关闭。',
    settings_desc_check_updates: '当有更新的 WebUI 或助手版本时显示横幅。会在后台定期执行 git fetch。',
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: '助手在 UI 中的显示名称。默认为 Intellect。',
    settings_desc_dashboard_title: '显示在顶栏 Logo 旁。默认为 Intellect Agent Harness。',
    settings_desc_password: '输入新密码以设置或更改。留空保持当前设置。',
    // onboarding
    onboarding_badge: '首次运行',
    onboarding_title: '欢迎使用 Intellect Web UI',
    archive_extracted: (n, c) => `从 ${c} 个压缩包中解压了 ${n} 个文件`,
    onboarding_lead: '快速引导将验证 Intellect、保存真实的提供商配置、选择工作区和模型，并可选设置密码保护应用。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '设置已跳过 — 使用现有配置。',
    onboarding_open: '打开 Intellect',
    onboarding_step_system_title: '系统检查',
    onboarding_step_system_desc: '验证 Intellect Agent 与配置可见性。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存最小可用的 Intellect 提供商配置。',
    ...
    onboarding_notice_system_ready: 'Intellect Agent 看起来可从 Web UI 访问。',
    onboarding_notice_system_unavailable: 'Intellect Agent 尚未完全可用。Bootstrap 可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: '请先在此选择一个简单的提供商路径。高级 OAuth 流程暂时仍建议在 Intellect CLI 中完成。',
    onboarding_notice_setup_already_ready: '已检测到可用的 Intellect 提供商配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '提供商已完成认证',
    onboarding_oauth_provider_ready_body: '此实例已配置为使用通过 Intellect CLI 设置的 OAuth 提供商（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth 提供商尚未认证',
    onboarding_oauth_provider_not_ready_body: '此实例已配置为使用 <strong>{provider}</strong>，该提供商使用 OAuth 而非 API key。请在终端运行 <code>intellect auth</code> 或 <code>intellect model</code> 完成认证，然后重新加载 Web UI。',
    ...
    onboarding_api_key_help_prefix: '会作为密钥保存到 Intellect .env 文件中，变量名为',
    onboarding_base_url_label: 'Base URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: '用于 OpenAI 兼容路由、自托管服务、LiteLLM、Ollama、LM Studio、vLLM 或类似端点。',
    onboarding_model_label: '默认模型',
    onboarding_workspace_help: '选择设置完成后 Intellect 在新聊天中使用的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    settings_section_preferences_meta: 'Intellect WebUI 的默认和 UI 行为。',
    ...
    status_profile: '配置文件',
    status_intellect_home: 'Intellect 主目录',
    status_started: '开始时间',
    status_tokens: '令牌',
    status_unknown: '未知',
    cmd_yolo: 'YOLO 模式切换',
    ...
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（音频波形）。让您自然说话 — Intellect 会在停顿后自动发送并朗读回复。需要支持语音识别和 TTS 的浏览器。',
  ...
  'zh-Hant': {
    ...
    provider_mismatch_warning: (m,p)=>`\"${m}\" \u53ef\u80fd\u7121\u6cd5\u5728\u7576\u524d\u914d\u7f6e\u7684\u63d0\u4f9b\u8005 (${p}) \u4e0b\u904b\u4f5c\u3002\u5c1a\u9001\uff0c\u6216\u5728\u7d42\u7aef\u57f7\u884c \`intellect model\` \u5207\u63db\u3002`,
    ...
    cmd_theme: '\u5207\u63db\u5916\u89c0\uff08\u4e3b\u984c\uff1asystem/dark/light\uff0c\u76ae\u819a\uff1adefault/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin\uff09',
    ...
    workspace_hidden_files_visible_title: 'Hidden files are visible — click for options',
    workspace_options: 'Workspace options',
    no_personalities: '\u6c92\u6709\u627e\u5230\u4eba\u8a2d\uff08\u53ef\u6dfb\u52a0\u5230 ~/.intellect/personalities/\uff09',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'Intellect Web UI 的預設值與介面行為。',
    ...
    settings_plugins_meta: '檢視已安裝的 Intellect 外掛及其註冊的生命週期鉤子。此面板為唯讀。',
    settings_plugins_empty: '目前沒有可見的 Intellect 外掛。透過 Intellect CLI/設定檔安裝或啟用外掛後即可在此檢視。',
    ...
    kanban_work_queue_hint: '這是 Intellect Agent 的工作佇列。建立或分類任務、指派對象、移至 Ready，然後讓調度器認領。',
    ...
    kanban_assignee_profiles_label: 'Intellect 設定檔',
    ...
    password_env_var_locked: '\u76ee\u524d\u5df2\u8a2d\u5b9a INTELLECT_WEBUI_PASSWORD \u74b0\u5883\u8b8a\u6578\u4e14\u512a\u5148\u751f\u6548\u3002\u8acb\u53d6\u6d88\u8a2d\u5b9a\u4e26\u91cd\u65b0\u555f\u52d5\u4f3a\u670d\u5668\uff0c\u624d\u80fd\u5728\u6b64\u7ba1\u7406\u5bc6\u78bc\u3002',
    password_env_var_locked_placeholder: '\u5df2\u9396\u5b9a\uff1a\u5df2\u8a2d\u5b9a INTELLECT_WEBUI_PASSWORD \u74b0\u5883\u8b8a\u6578',
    disable_auth: '\u505c\u7528\u9a57\u8b49',
    ...
    settings_desc_sync_insights: '將 WebUI token 使用情況同步到 state.db，使 intellect /insights 包含瀏覽器會話數據。預設未啟用。',
    ...
    tab_teams: '\u5718\u968a',
    tab_settings: '\u8a2d\u5b9a',
    members_panel_desc: '\u672c\u914d\u7f6e\u4e0b\u7684\u6210\u54e1\u3001OAuth \u8eab\u4efd\u3001API \u4ee4\u724c\u8207\u5718\u968a\u3002',
    members_disabled: '\u6b64\u914d\u7f6e\u672a\u555f\u7528\u6210\u54e1\u529f\u80fd\u3002',
    members_sign_in_first: '\u8acb\u5148\u767b\u5165\u4ee5\u7ba1\u7406\u6210\u54e1\u3002',
    member_login_title: '\u767b\u5165',
    member_login_sub: '\u4f7f\u7528\u7d44\u7e54\u5e33\u865f\u5b58\u53d6\u6b64 Intellect \u914d\u7f6e\u3002',
    member_login_invite: '\u9080\u8acb\u78bc\uff08\u9078\u586b\uff09',
    member_sign_out: '\u767b\u51fa',
    member_not_signed_in: '\u672a\u767b\u5165',
    member_team_banner: '\u8acb\u9078\u64c7\u4e00\u500b\u4f7f\u7528\u4e2d\u7684\u5718\u968a\u4ee5\u7e7c\u7e8c\u3002',
    teams_panel_desc: '\u52a0\u5165\u5718\u968a\u3001\u9078\u64c7\u4f7f\u7528\u4e2d\u5718\u968a\u3001\u5be9\u6279\u52a0\u5165\u7533\u8acb\u3002',
    teams_open_panel: '\u958b\u555f\u5718\u968a\u9762\u677f',
    members_setup_title: '\u6210\u54e1\u8207 OAuth',
    members_setup_desc: '\u591a\u4f7f\u7528\u8005\u6a21\u5f0f\u4f7f\u7528 intellect-agent \u6210\u54e1\u8cc7\u6599\u5eab\u3002Member OAuth \u56de\u547c\u5fc5\u9808\u6307\u5411\u672c WebUI\uff08\u975e :9009 dashboard\uff09\u3002',
    members_setup_callback_title: '\u5efa\u8b70\u7684 OAuth \u56de\u547c\u57fa\u790e\u4f4d\u5740',
    members_setup_callback_hint: '\u65bc config.yaml \u8a2d\u5b9a members.oauth.callback_base_url \u70ba WebUI \u5c0d\u5916 URL\u3002',
    members_redeem_invite: '\u514c\u63db\u9080\u8acb\u78bc',
    members_redeem_btn: '\u514c\u63db',
    members_sign_in_or_redeem: '\u8acb\u4f7f\u7528 OAuth \u767b\u5165\u6216\u514c\u63db\u9080\u8acb\u78bc\u3002',
    members_link_provider: '\u7d81\u5b9a',
    members_link_provider_hint: '\u70ba\u6b64\u6210\u54e1\u7d81\u5b9a\u5176\u4ed6\u767b\u5165\u65b9\u5f0f\uff1a',
    ...
    jump_to_question: '回到問題',
    jump_to_question_label: '跳至這則回答對應的問題',
    onboarding_api_key_help_prefix: '\u900f\u904e\u4ee5\u4e0b\u65b9\u5f0f\u5132\u5b58\u70ba Intellect .env \u6a94\u6848\u4e2d\u7684\u6a5f\u5bc6',
    ...
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5 Intellect\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 Intellect \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: '\u5728\u6b64\u9078\u64c7\u5feb\u901f\u63d0\u4f9b\u8005\u8a2d\u5b9a\u8def\u5f91\u3002\u9032\u968e OAuth \u8a2d\u5b9a\u4ecd\u8acb\u4f7f\u7528 Intellect CLI\u3002',
    onboarding_notice_system_ready: 'Intellect Agent \u53ef\u5f9e Web UI \u5b58\u53d6\u3002',
    onboarding_notice_system_unavailable: 'Intellect Agent \u5c1a\u672a\u5b8c\u5168\u53ef\u7528\u3002\u5f15\u5c0e\u7a0b\u5f0f\u53ef\u80fd\u5b89\u88dd\u5b83\uff0c\u4f46\u63d0\u4f9b\u8005\u8a2d\u5b9a\u53ef\u80fd\u4ecd\u9700\u7d42\u7aef\u6a5f\u3002',
    onboarding_notice_workspace: '\u9019\u4e9b\u503c\u4f7f\u7528\u8207\u4e00\u822c\u61c9\u7528\u7a0b\u5f0f\u76f8\u540c\u7684\u8a2d\u5b9a API\u3002',
    onboarding_oauth_provider_not_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528 <strong>{provider}</strong>\uff0c\u5b83\u4f7f\u7528 OAuth \u800c\u975e API \u91d1\u9470\u3002\u8acb\u5728\u7d42\u7aef\u6a5f\u4e2d\u57f7\u884c <code>intellect auth</code> \u6216 <code>intellect model</code> \u9032\u884c\u6388\u6b0a\uff0c\u7136\u5f8c\u91cd\u65b0\u6574\u7406 Web UI\u3002',
    onboarding_oauth_provider_not_ready_title: 'OAuth \u63d0\u4f9b\u8005\u5c1a\u672a\u6388\u6b0a',
    onboarding_oauth_provider_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528\u900f\u904e Intellect CLI \u914d\u7f6e\u7684 OAuth \u63d0\u4f9b\u8005\uff08<strong>{provider}</strong>\uff09\u3002\u7121\u9700 API \u91d1\u9470 \u2014 \u6309\u7e7c\u7e8c\u5b8c\u6210\u8a2d\u5b9a\u3002',
    onboarding_oauth_provider_ready_title: '\u63d0\u4f9b\u8005\u5df2\u6388\u6b0a',
    onboarding_oauth_switch_hint: '\u6216\u9078\u64c7\u4e0b\u65b9\u5176\u4ed6\u63d0\u4f9b\u8005\u4ee5\u5207\u63db\u5230 API \u91d1\u9470\u8a2d\u5b9a\uff1a',
    onboarding_open: '\u958b\u555f Intellect',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 Intellect \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 Intellect Agent \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 Intellect Web UI',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 Intellect \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    providers_oauth_config_yaml_hint: '\u5df2\u900f\u904e config.yaml \u8a2d\u5b9a\u6b0a\u8b49\u3002\u8981\u66f4\u65b0\uff0c\u8acb\u7de8\u8f2f config.yaml \u4e2d\u7684 providers \u5340\u6bb5\uff0c\u6216\u57f7\u884c intellect auth\u3002',
    providers_oauth_not_configured_hint: '\u5c1a\u672a\u9a57\u8b49\u3002\u8acb\u5728\u7d42\u7aef\u6a5f\u57f7\u884c intellect auth \u4ee5\u8a2d\u5b9a\u6b64\u63d0\u4f9b\u8005\u3002',
    providers_remove: '\u79fb\u9664',
    providers_removing: '\u79fb\u9664\u4e2d\u2026',
    providers_save: '\u5132\u5b58',
    ...
    status_profile: '個人資料',
    status_intellect_home: 'Intellect 主目錄',
    status_started: '開始時間',
    status_tokens: 'Token',
    status_updated: '已更新',
  ...
  pt: {
    ...
    offline_network_detail: 'O Intellect está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o Intellect voltar a responder.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" pode não funcionar com seu provedor configurado (${p}). Enviar assim mesmo, ou execute \`intellect model\` no terminal para trocar.`,
    ...
    cmd_theme: 'Trocar aparência (tema: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    cmd_personality: 'Trocar personalidade do agente',
    cmd_skills: 'Listar skills disponíveis do Intellect',
    ...
    status_intellect_home: 'Diretório Intellect',
    ...
    no_personalities: 'Nenhuma personalidade encontrada (adicione em ~/.intellect/personalities/)',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do Intellect Web UI.',
    settings_section_system_title: 'Sistema',
    ...
    kanban_assignee_profiles_label: 'Perfis Intellect',
    ...
    tab_dashboard: 'Painel Intellect',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Nome de exibição do assistente. Padrão: Intellect.',
    ...
    password_env_var_locked: 'A variável de ambiente INTELLECT_WEBUI_PASSWORD está definida e tem prioridade. Remova-a e reinicie o servidor para gerenciar a senha aqui.',
    password_env_var_locked_placeholder: 'Bloqueado: variável INTELLECT_WEBUI_PASSWORD está definida',
    ...
    providers_oauth_config_yaml_hint: 'Token configurado via config.yaml. Para atualizar, edite config.yaml ou rode intellect auth.',
    providers_oauth_not_configured_hint: 'Não autenticado. Rode intellect auth no terminal.',
    ...
    onboarding_title: 'Bem-vindo ao Intellect Web UI',
    onboarding_lead: 'Uma configuração rápida vai verificar Intellect, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar Intellect Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor Intellect.',
    ...
    onboarding_notice_system_ready: 'Intellect Agent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: 'Intellect Agent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    onboarding_check_agent: 'Intellect Agent',
    ...
    onboarding_notice_setup_required: 'Escolha caminho simples de provedor aqui. OAuth avançado ainda pertence ao Intellect CLI.',
    onboarding_notice_setup_already_ready: 'Setup de provedor Intellect já detectado. Pode manter ou substituir.',
    ...
    onboarding_oauth_provider_not_ready_body: 'Esta instância usa <strong>{provider}</strong> com OAuth. Rode `intellect auth` no terminal.',
    ...
    onboarding_api_key_placeholder_optional: 'Leave blank for keyless servers', // TODO: translate
    onboarding_api_key_help_keyless: 'Most LM Studio / Ollama / vLLM installs run keyless — leave this blank if your server doesn\'t require authentication. Use the Test connection button to verify.', // TODO: translate
    onboarding_api_key_help_prefix: 'Salvo como segredo no .env do Intellect usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Escolha modelo que Intellect deve usar para novos chats.',
  ...
  ko: {
    ...
    offline_network_detail: '현재 이 브라우저에서 Intellect에 연결할 수 없습니다.',
    offline_autorefresh: 'Intellect에 다시 연결되면 이 페이지를 자동으로 새로고침합니다.',
    ...
    status_profile: '프로필',
    status_intellect_home: 'Intellect 홈',
    ...
    settings_section_preferences_meta: 'Intellect Web UI의 기본값과 UI 동작.',
    ...
    kanban_assignee_profiles_label: 'Intellect 프로필',
    ...
    settings_desc_sync_insights: 'WebUI 토큰 사용량을 state.db에 반영하여 intellect /insights에 브라우저 세션 데이터가 포함되도록 합니다. 기본값은 꺼짐입니다.',
    settings_desc_check_updates: 'WebUI 또는 Agent의 새 버전이 있으면 배너를 표시합니다. 백그라운드에서 주기적으로 git fetch를 실행합니다.',
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'UI 전체에 표시되는 Assistant 이름입니다. 기본값은 Intellect입니다.',
    settings_desc_password: '새 비밀번호를 설정하거나 변경하려면 입력하세요. 현재 설정을 유지하려면 비워 두세요.',
    password_placeholder: '새 비밀번호 입력…',
    password_env_var_locked: '현재 INTELLECT_WEBUI_PASSWORD 환경 변수가 설정되어 있어 우선 적용됩니다. 변수를 해제하고 서버를 재시작해야 여기에서 비밀번호를 관리할 수 있습니다.',
    password_env_var_locked_placeholder: '잠금: INTELLECT_WEBUI_PASSWORD 환경 변수가 설정되어 있습니다',
    ...
    onboarding_title: 'Intellect Web UI에 오신 것을 환영합니다',
    onboarding_lead: '간단한 안내 설정으로 Intellect 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
  ...
  fr: {
    ...
    offline_network_detail: 'Intellect est actuellement inaccessible depuis ce navigateur.',
    ...
    mcp_restart_hint: 'Les modifications apportées au serveur sont en lecture seule ici pour le moment. Modifiez config.yaml et redémarrez Intellect pour que les modifications prennent effet.',
    ...
    cmd_theme: 'Changer d\'apparence (thème : system/dark/light, skin : default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin)',
    ...
    status_intellect_home: 'Maison Hermès',
    ...
    no_personalities: 'Aucune personnalité trouvée (ajoutez-les à ~/.intellect/personalities/)',
    ...
    settings_section_preferences_meta: 'Paramètres par défaut et comportement de l\'interface utilisateur pour Intellect Web UI.',
    ...
    kanban_work_queue_hint: 'Il s\'agit de la file d\'attente de travail de l\'agent Intellect. Créez ou triez une tâche, attribuez-la, déplacez-la vers Prêt, puis laissez le répartiteur la réclamer.',
    ...
    settings_desc_sync_insights: 'Met en miroir l\'utilisation du jeton WebUI dans state.db afin que Intellect /insights inclut les données de session du navigateur. Désactivé par défaut.',
    ...
    password_env_var_locked: 'La variable d\'environnement INTELLECT_WEBUI_PASSWORD est actuellement définie et est prioritaire. Désactivez-le et redémarrez le serveur pour gérer le mot de passe à partir d\'ici.',
    password_env_var_locked_placeholder: 'Verrouillé : la variable d\'environnement INTELLECT_WEBUI_PASSWORD est définie',
    ...
    providers_oauth_config_yaml_hint: 'Jeton configuré via config.yaml. Pour mettre à jour, modifiez la section des fournisseurs dans votre config.yaml ou exécutez Intellect Auth.',
    providers_oauth_not_configured_hint: 'Non authentifié. Exécutez Intellect Auth dans le terminal pour configurer ce fournisseur.',
    ...
    onboarding_lead: 'Une configuration guidée rapide vérifiera Intellect, enregistrera une configuration réelle du fournisseur, choisira un espace de travail et un modèle et protégera éventuellement l\'application avec un mot de passe.',
    onboarding_back: 'Dos',
    ...
    onboarding_step_system_desc: 'Vérifiez la visibilité de l\'agent Intellect et de la configuration.',
    onboarding_step_setup_title: 'Configuration du fournisseur',
    onboarding_step_setup_desc: 'Enregistrez la configuration minimale du fournisseur Intellect.',
    ...
    onboarding_notice_system_ready: 'L\'agent Intellect semble accessible depuis l\'interface utilisateur Web.',
    onboarding_notice_system_unavailable: 'Intellect Agent n’est pas encore entièrement disponible. Bootstrap peut l\'installer, mais la configuration du fournisseur peut toujours nécessiter un terminal.',
    ...
    onboarding_notice_setup_required: 'Choisissez ici un chemin de fournisseur simple. Les flux OAuth avancés appartiennent toujours à la CLI Intellect pour le moment.',
    onboarding_notice_setup_already_ready: 'Une configuration de fournisseur Intellect fonctionnelle est déjà détectée. Vous pouvez le conserver ou le remplacer ici.',
    onboarding_oauth_provider_ready_title: 'Fournisseur déjà authentifié',
    onboarding_oauth_provider_ready_body: 'Cette instance est configurée pour utiliser un fournisseur OAuth (<strong>{provider}</strong>) configuré via la CLI Intellect. Aucune clé API n\'est nécessaire ici - cliquez sur Continuer pour terminer la configuration.',
    onboarding_oauth_provider_not_ready_title: 'Fournisseur OAuth pas encore authentifié',
    onboarding_oauth_provider_not_ready_body: 'Cette instance est configurée pour utiliser <strong>{provider}</strong>, qui utilise OAuth plutôt qu\'une clé API. Exécutez <code>intellect auth</code> ou <code>intellect model</code> dans un terminal pour vous authentifier, puis rechargez l\'interface utilisateur Web.',
    ...
    onboarding_api_key_help_prefix: 'Enregistré comme secret dans votre fichier Intellect .env en utilisant',
    ...
    onboarding_workspace_help: 'Choisissez le modèle qu\'Intellect doit utiliser pour les nouvelles discussions une fois la configuration terminée.',
  ...
  tr: {
    ...
    password_env_var_locked: 'INTELLECT_WEBUI_PASSWORD ortam değişkeni şu anda ayarlıdır ve önceliklidir. Şifreyi buradan yönetmek için ayarı kaldırın ve sunucuyu yeniden başlatın.',
    password_env_var_locked_placeholder: 'Kilitli: INTELLECT_WEBUI_PASSWORD ortam değişkeni ayarlandı',
...
function setLocale(lang) {
  ...
  localStorage.setItem('intellect-lang', resolved);
 ...
 */
function loadLocale() {
  setLocale(resolvePreferredLocale(null, localStorage.getItem('intellect-lang')));
}
